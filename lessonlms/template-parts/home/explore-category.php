...
<div class="explore-section">
    <div class="container">
        ...
        <div class="explore-category-heading">
            <h1>
                <?php echo esc_html__( 'Explore Categories', 'lessonlms' ); ?>
            </h1>
            <p>
                <?php echo esc_html__( 'Discover categories designed to help you excel in your professional and personal growth.', 'lessonlms' ); ?>
            </p>
        </div>
